...
Fetched 2026-09-15T06:16:05Z by `scripts/common/mine-repo.sh`.

| | |
| --- | --- |
| commit | `4b63868f0d67e4ee0fa690bb14cb5722b78d679d` |
| route | proxy |
...
## ⛔ What this fetch did NOT get
  ...
  - tree/ had binary media (png/jpg/gif/webp/ico/mp4/fonts) and dependency lockfiles deleted, and node_modules, .venv, target and dist pruned. Paths were not rewritten.
  - tree/ TRIMMED BY DELETION to docs/, site/, examples/, README*, roadmap.md, SECURITY.md, LICENSE. The Go controller source was deleted: this reference was swept as an orchestrator design, not as code to port. Paths were not rewritten.
  - comments and review comments are capped at 1000 records per source by the fetch. Where a count reads exactly 1000 the source is TRUNCATED, not complete.
