...
- ⭐ **This repository is 0BSD.** [`../../LICENSE`](../../LICENSE) is the text.
  Use it, copy it, change it, ship it: no attribution, no notice to carry, no
  conditions. It is chosen because every condition is one more thing a coding
  agent asked to reuse a file can decline over.
...
⚠ **This repository has none**, deliberately: nobody but the operator has opened
one.
