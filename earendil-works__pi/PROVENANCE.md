...
| | |
| --- | --- |
| commit | `f9bcd351dc3cedf989bc5fc0f8aa012db5737df2` |
...
## ⛔ What this fetch did NOT get, and why
  ...
  - **the source: deleted.** `tree/` holds the 144 markdown files and nothing
...
⛔ **This was first fetched and pinned as `badlogic/pi-mono`, a mirror.** Both
clones resolve to the commit above and the cited files are byte-identical, so
every quotation taken from it is still verbatim correct. What was wrong was the
provenance: a citation naming a repository nobody goes to is uncheckable where
