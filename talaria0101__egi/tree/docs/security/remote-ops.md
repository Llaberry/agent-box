...
Re-derive every claim in an open item against the tree or the API before acting. Report what was checked, not what the item said. ⚠ **No reading of an item decides whether a change is a good idea.** That stays a separate reading.
